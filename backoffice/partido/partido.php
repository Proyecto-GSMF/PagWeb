    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-dark" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a class="list-group-item list-group-item-action list-group-item-dark p-3" href="partido.php">Partidos</a>
                <div class="dropdown">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="card mb-3">
                            <div class="card-body">
                                <h5 class="card-title">Crear un encuentro</h5>
                                <p class="card-text">Crear un encuentro para un evento. </p>
                                ...
                                <div class="collapse" id="collapseExample">
                                    <div class="card card-body">
                                        <div class="formulario">
                                            <form enctype="multipart/form-data" action="partidodbconn.php" method="POST">


                                                <select class="form-select mb-3" name="deporte" aria-label="Default select example" required>
                                                    <option value="" selected>Selecciona un deporte para el encuentro</option>
                                                    <?php
                                                ...
                                                <div class="row mb-3">
                                                    <label class="label1">Nombre del encuentro</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="row mb-3">
                                                    <label class="label1">Lugar donde se disputara el encuentro</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="row mb-3">
                                                    <label class="label1">Nombre del Árbitro del partido</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="nArb" class="form-control form1" required>
                                                    </div>
                                                </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <p class="card-text">Permite editar un encuentro previamente registrado </p>
                                <a class="btn btn-primary" role="button" href="editarpartido.php">
                                    Editar encuentro
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <h5 class="card-title">Actualizar un encuentro</h5>
                                <p class="card-text">Permite actualizar los datos de un evento y su resultado.</p>
                                <a class="btn btn-primary" role="button" href="actualizarpartido.php">
                    ...
                    <div class="col-sm-6">
                        <div class="card mb-3">
                            <div class="card-body">
                                <h5 class="card-title">Borrar encuentros</h5>
                                <p class="card-text">Permite borrar los encuentros ya registrados</p>
                                ...
                                <div class="collapse" id="collapse2">
                                    <div class="card card-body">
                                        <div class="formulario">
                                            <form action="delpartidodbconn.php" method="POST">
                                                <select class="form-select mb-3" name="delpid" aria-label="Default select example" required>
                                                    <option selected value="">Selector de encuentros</option>
                                                    <?php
